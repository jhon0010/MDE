...
public interface ActionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACTION_RELATIONSHIP__FROM = ABSTRACT_ACTION_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACTION_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_ACTION_RELATIONSHIP_FEATURE_COUNT + 1;
