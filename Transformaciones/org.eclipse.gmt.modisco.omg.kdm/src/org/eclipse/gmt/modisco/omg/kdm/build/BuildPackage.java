...
public interface BuildPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_BUILD_ELEMENT__BUILD_RELATION = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_BUILD_ELEMENT_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int BUILD_RESOURCE__GROUPED_BUILD = ABSTRACT_BUILD_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BUILD_RESOURCE__BUILD_ELEMENT = ABSTRACT_BUILD_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int BUILD_RESOURCE_FEATURE_COUNT = ABSTRACT_BUILD_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int BUILD_RELATIONSHIP__FROM = ABSTRACT_BUILD_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BUILD_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_BUILD_RELATIONSHIP_FEATURE_COUNT + 1;
