...
public interface CodePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT__COMMENT = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT__CODE_RELATION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT__ENTRY_FLOW = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CODE_ELEMENT_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int CODE_RELATIONSHIP__FROM = ABSTRACT_CODE_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CODE_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_CODE_RELATIONSHIP_FEATURE_COUNT + 1;
