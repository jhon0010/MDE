...
public interface ConceptualPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_CONCEPTUAL_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CONCEPTUAL_ELEMENT__CONCEPTUAL_RELATION = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CONCEPTUAL_ELEMENT__ABSTRACTION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_CONCEPTUAL_ELEMENT_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int CONCEPTUAL_RELATIONSHIP__FROM = ABSTRACT_CONCEPTUAL_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONCEPTUAL_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_CONCEPTUAL_RELATIONSHIP_FEATURE_COUNT + 1;
