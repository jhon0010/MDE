...
public interface DataPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_DATA_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DATA_ELEMENT__DATA_RELATION = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DATA_ELEMENT__ABSTRACTION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DATA_ELEMENT_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int DATA_RELATIONSHIP__FROM = ABSTRACT_DATA_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DATA_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_DATA_RELATIONSHIP_FEATURE_COUNT + 1;
