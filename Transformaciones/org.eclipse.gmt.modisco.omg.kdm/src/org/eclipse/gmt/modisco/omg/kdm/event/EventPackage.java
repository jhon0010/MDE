...
public interface EventPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_EVENT_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_EVENT_ELEMENT__EVENT_RELATION = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_EVENT_ELEMENT__ABSTRACTION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_EVENT_ELEMENT__IMPLEMENTATION = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_EVENT_ELEMENT_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int EVENT_RELATIONSHIP__FROM = ABSTRACT_EVENT_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EVENT_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_EVENT_RELATIONSHIP_FEATURE_COUNT + 1;
