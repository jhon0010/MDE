...
public interface PlatformPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_PLATFORM_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_PLATFORM_ELEMENT__PLATFORM_RELATION = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_PLATFORM_ELEMENT__ABSTRACTION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_PLATFORM_ELEMENT__IMPLEMENTATION = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_PLATFORM_ELEMENT_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int PLATFORM_RELATIONSHIP__FROM = ABSTRACT_PLATFORM_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PLATFORM_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_PLATFORM_RELATIONSHIP_FEATURE_COUNT + 1;
