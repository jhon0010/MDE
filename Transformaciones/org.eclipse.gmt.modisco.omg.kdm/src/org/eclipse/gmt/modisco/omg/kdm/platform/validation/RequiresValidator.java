...
/**
 * A sample validator interface for {@link org.eclipse.gmt.modisco.omg.kdm.platform.Requires}.
...
public interface RequiresValidator {
	...
	boolean validateTo(AbstractPlatformElement value);
	boolean validateFrom(DeployedComponent value);
}
