...
public interface SourcePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_INVENTORY_ELEMENT__INVENTORY_RELATIONSHIP = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_INVENTORY_ELEMENT_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int INVENTORY_RELATIONSHIP__FROM = ABSTRACT_INVENTORY_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INVENTORY_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_INVENTORY_RELATIONSHIP_FEATURE_COUNT + 1;
