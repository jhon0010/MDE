...
public interface StructurePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_STRUCTURE_ELEMENT__AGGREGATED = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_STRUCTURE_ELEMENT__STRUCTURE_ELEMENT = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_STRUCTURE_ELEMENT__STRUCTURE_RELATIONSHIP = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_STRUCTURE_ELEMENT_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int STRUCTURE_RELATIONSHIP__FROM = ABSTRACT_STRUCTURE_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int STRUCTURE_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_STRUCTURE_RELATIONSHIP_FEATURE_COUNT + 1;
