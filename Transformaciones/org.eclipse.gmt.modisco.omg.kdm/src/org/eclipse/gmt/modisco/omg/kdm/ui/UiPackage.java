...
public interface UiPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_UI_ELEMENT__SOURCE = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_UI_ELEMENT__UI_RELATION = 1;
	 ...
	 * @ordered
	 */
	int ABSTRACT_UI_ELEMENT__IMPLEMENTATION = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_UI_ELEMENT__ABSTRACTION = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_UI_ELEMENT_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int UI_RELATIONSHIP__FROM = ABSTRACT_UI_RELATIONSHIP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int UI_RELATIONSHIP_FEATURE_COUNT = ABSTRACT_UI_RELATIONSHIP_FEATURE_COUNT + 1;
